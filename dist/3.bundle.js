...
var _reactOcticons = __webpack_require__(29);

var _chart = __webpack_require__(2345);

var _chart2 = _interopRequireDefault(_chart);

var _database = __webpack_require__(92);
...
const BurnupShell = _react2.default.createClass({
  ...
  renderLoaded(cards) {
    ...
    function formatChunk(chunk) {
      if (chunkType === 'day') {
        const m = new _moment2.default(chunk * 1000 * 60 * 60 * 24);
    ...
    cards = _underscore2.default.sortBy(cards, card => getDay(card.issue.createdAt));
    ...
    closedCards = _underscore2.default.sortBy(closedCards, card => getDay(card.issue.closedAt));
    let endDate;
  ...
  render() {
    ...
    const promise = _database2.default.fetchCards((0, _routeUtils.getFilters)());
...
var _c = __webpack_require__(2346);
...
const ChartComponent = _react2.default.createClass({
...
function ChartInternal(api) {
    var $$ = this;
    $$.d3 = window.d3 ? window.d3 :  true ? __webpack_require__(2347) : undefined;
    $$.api = api;
